...
*
* @param {ArrayLikeObject<Object>} descriptors - list of ndarray descriptors
* @param {Collection<number>} offsets - list of index offsets
* @returns {ArrayLikeObject<Object>} input array
*
* @example
...
module.exports = setDescriptorOffsets;
