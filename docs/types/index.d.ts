...
import { Descriptor } from '@stdlib/types/ndarray';
...
* // returns 2
*/
declare function setDescriptorOffsets<T extends ArrayLike<Descriptor> = ArrayLike<Descriptor>>( descriptors: T, offsets: Collection<number> ): T;


// EXPORTS //

export = setDescriptorOffsets;
