...
```javascript
import setDescriptorOffsets from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-set-descriptor-offsets@deno/mod.js';
```
...
import ndarraylike2descriptor from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ndarraylike2descriptor@deno/mod.js';
...
import ndarraylike2descriptor from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-ndarraylike2descriptor@deno/mod.js';
import getOffsets from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-offsets@deno/mod.js';
import setDescriptorOffsets from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-set-descriptor-offsets@deno/mod.js';
